...
class Dashboard_model extends CI_Model
{
    ...
    {
        $this->db->select('tbl_billboards.*, tbl_traffic_data.*,tbl_locations.*, sum(tbl_traffic_data.vehicle_count) as total_vehicle_count');
    ...
    {
        $this->db->select('tbl_customer_details.*, count(tbl_advertisements.id) as total_ads, tbl_users.name');
