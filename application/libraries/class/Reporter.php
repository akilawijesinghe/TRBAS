...
include_once 'application/libraries/fpdf/fpdf.php';


class Reporter extends FPDF
{
    ...
    function __construct($data)
    {
        ...
        if(!defined('FPDF_FONTPATH')){
            define('FPDF_FONTPATH', 'application/views/report/fpdf/');
        }
        ...
        // $this->AddFont('latha', '', 'Latha.php');
        // $this->AddFont('SriTamSans', '', 'SriTamSans.php');
    }
...
//	}
    ...
    public function setBarcode($barcode, $x = 0, $y = 0, $frame = false, $pb = 30, $text = false)
    {
